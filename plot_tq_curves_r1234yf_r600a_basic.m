function plot_tq_curves_r1234yf_r600a_basic(year_value)
% Plot dual-pressure ORC T-Q curves for R1234yf and R600A.
%
...
outdir = fullfile(script_dir, 'figures_tq_curves_r1234yf_r600a_basic');
if ~exist(outdir, 'dir')
    mkdir(outdir);
end
...
for idx = 1:numel(target_fluids)
    ...
    if ~details.feasible
        error('plot_tq_curves_basic:%sInfeasible', fluid, ...
